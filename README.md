...
## download
A pre-built runnable .jar file can be downloaded from [here](https://www.dropbox.com/s/c2d65sxxqm61068/Korean%20Lookup.jar?dl=0). Simply download the .jar and run it.
